...
const Employee = () => {
    ...
    return ( 
        <div>
            <Nav_bar/>
        <div className="form_emp border w-25 rounded m-auto p-3  bg-success text-white  bg-opacity-50">
            ...
            <div className="name ps-3 pt-3">
                ...
                <div>
                    ...
                    <input type="Date" className="bg-light rounded p-2 ms-3" ref={date}  />
                </div>
                ...
                <div className="file_upload mt-3 ms-3 ">
